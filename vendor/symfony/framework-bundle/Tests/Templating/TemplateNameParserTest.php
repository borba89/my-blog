...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:login.html.twig', 'FooBundle:Post:login.html.twig', '@FooBundle/Resources/views/Post/login.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
