...
// Returns the public 'admin.user' autowired service.
...
include_once $this->targetDirs[3].'/src/Admin/UserAdmin.php';
...
$this->factories['admin.user'] = function () {
    $instance = new \App\Admin\UserAdmin('admin.user', 'App\\Entity\\User', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['admin.user.template_registry'] ?? $this->load('getAdmin_User_TemplateRegistryService.php')));
...
return $this->factories['admin.user']();
