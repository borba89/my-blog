...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/mgilet/notification-bundle/Manager/NotificationManager.php';
            include_once $this->targetDirs[3].'/vendor/mgilet/notification-bundle/NotifiableDiscovery.php';
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Mgilet\NotificationBundle\Twig\NotificationExtension(($this->services['mgilet.notification'] ?? $this->getMgilet_NotificationService()), $j, $instance, $f));
