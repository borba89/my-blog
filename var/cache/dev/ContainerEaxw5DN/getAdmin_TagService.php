...
// Returns the public 'admin.tag' autowired service.
...
include_once $this->targetDirs[3].'/src/Admin/TagAdmin.php';
...
$this->factories['admin.tag'] = function () {
    $instance = new \App\Admin\TagAdmin('admin.tag', 'App\\Entity\\Tag', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['admin.tag.template_registry'] ?? $this->load('getAdmin_Tag_TemplateRegistryService.php')));
...
return $this->factories['admin.tag']();
