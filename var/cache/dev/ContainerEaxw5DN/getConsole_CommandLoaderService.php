...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'fos_elastica.command.create' => array('privates', 'fos_elastica.command.create', 'getFosElastica_Command_CreateService.php', true),
    'fos_elastica.command.populate' => array('privates', 'fos_elastica.command.populate', 'getFosElastica_Command_PopulateService.php', true),
    'fos_elastica.command.reset' => array('privates', 'fos_elastica.command.reset', 'getFosElastica_Command_ResetService.php', true),
    'fos_elastica.command.search' => array('privates', 'fos_elastica.command.search', 'getFosElastica_Command_SearchService.php', true),
    'lexik_jwt_authentication.check_config_command' => array('services', 'lexik_jwt_authentication.check_config_command', 'getLexikJwtAuthentication_CheckConfigCommandService.php', true),
    'lexik_jwt_authentication.generate_token_command' => array('services', 'lexik_jwt_authentication.generate_token_command', 'getLexikJwtAuthentication_GenerateTokenCommandService.php', true),
