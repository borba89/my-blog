...
// Returns the public 'admin.comment' autowired service.
...
include_once $this->targetDirs[3].'/src/Admin/CommentAdmin.php';
...
$this->factories['admin.comment'] = function () {
    $instance = new \App\Admin\CommentAdmin('admin.comment', 'App\\Entity\\Comment', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Comment');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.comment.template_registry'] ?? $this->load('getAdmin_Comment_TemplateRegistryService.php')));
...
return $this->factories['admin.comment']();
