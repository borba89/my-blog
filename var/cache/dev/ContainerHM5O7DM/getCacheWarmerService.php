...
return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
    ...
    yield 9 => ($this->services['sonata.admin.route.cache_warmup'] ?? $this->load('getSonata_Admin_Route_CacheWarmupService.php'));
}, 10), true, ($this->targetDirs[0].'/srcApp_KernelDevDebugContainerDeprecations.log'));
