...
return $this->services['eight_points_guzzle.client.my_client'] = new \GuzzleHttp\Client(array('base_uri' => NULL, 'handler' => $a, 'timeout' => 30.0, 'http_errors' => true, 'headers' => array('User-Agent' => 'EightPointsGuzzleBundle/v7')));
