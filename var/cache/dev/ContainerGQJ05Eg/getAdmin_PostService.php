...
// Returns the public 'admin.post' autowired service.
...
include_once $this->targetDirs[3].'/src/Admin/PostAdmin.php';
...
$this->factories['admin.post'] = function () {
    $instance = new \App\Admin\PostAdmin('admin.post', 'App\\Entity\\Post', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['admin.post.template_registry'] ?? $this->load('getAdmin_Post_TemplateRegistryService.php')));
...
return $this->factories['admin.post']();
